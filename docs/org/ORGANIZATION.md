...
`checks[]` (contract items passed), and a state-specific `payload`. One writer per file;
...
| `org-protocol`              | (envelope/state-machine/recovery spec; `date -u`, `.tribes/org/` layout)                                                        | —                                                           |
