...
export function buildPredictionCommand(): Command {
  const service = new PredictionService()

  const program = new Command('prediction')
  program.description('Polymarket prediction market research CLI').version(VERSION)
