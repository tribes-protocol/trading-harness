...
/**
 * Title applied when the caller passes none. Shared because the `osc` backend
 * has to tell "caller set no title" from "caller set this exact title" to pick
 * between the bare OSC 9 form and OSC 777.
 */
export const DEFAULT_NOTIFY_TITLE = 'Tribes Agent'
